...
public class JobConsumer {
    ...
    public void consume(
        ...
        log.info(
                "1. Kafka RECEIVED | jobId={} | type={} | priority={}",
                message.jobId(),
                message.jobType(),
                message.priority()
        ...
        try {
            ...
            log.info(
                    "2. Job SUBMITTING to dispatcher | jobId={}",
                    message.jobId()
            );
            ...
            log.info(
                    "6. Worker processing SUCCESS | jobId={}",
                    message.jobId()
            );
            ...
            log.error(
                    "Kafka processing FAILED - ACK will NOT be sent | jobId={}",
                    message.jobId(),
                    e
            );
